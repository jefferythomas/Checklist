...
extension Process {
    /**
     Errors generated by PromiseKit’s NSTask extensions
     */
    public enum Error: Swift.Error {
        /// The data could not be converted to a UTF8 String
        case encoding(stdout: Data, stderr: Data)
        /// The task execution failed
        case execution(task: Process, stdout: Data, stderr: Data)
    ...
    /**
     ...
     - Returns: A promise that fulfills with three parameters:
    ...
    public func promise() -> Promise<(Data, Data, Int)> {
        ...
        return DispatchQueue.global().promise {
            ...
            let stdout = (self.standardOutput! as! Pipe).fileHandleForReading.readDataToEndOfFile()
            let stderr = (self.standardError! as! Pipe).fileHandleForReading.readDataToEndOfFile()
