...
extension URLSession {
    ...
    /**
     ...
     your `URLRequest` and the `URLSession`. Often this is necessary if your
     API requires authentication in the HTTP headers.
     ...
     We recommend the use of [OMGHTTPURLRQ] which allows you to construct correct REST requests.
        ...
        NSURLSession.promise(rq).asDictionary().then { json in
            //…
        }
