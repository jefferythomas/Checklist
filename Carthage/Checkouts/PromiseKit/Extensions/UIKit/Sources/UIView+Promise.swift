...
extension UIView {
    ...
    */
    public class func animate(withDuration duration: TimeInterval = 0.3, delay: TimeInterval = 0, options: UIViewAnimationOptions = UIViewAnimationOptions(), animations: @escaping () -> Void) -> Promise<Bool> {
